...
export default function ActivitySummary({ income, expense, savings }: Props) {
  ...
  return (
    <div className="rounded-[18px] p-5 border border-[#C9A84C]/20 shadow-sm" style={{ backgroundColor: '#FEF3DC' }}>
      <div className="flex items-center gap-2.5 mb-4">
        ...
        <div>
          ...
          <p className="text-xs text-[#94A3B8] font-[family-name:var(--font-inter)]">Résumé commercial du mois</p>
        </div>
      </div>

      <div className="bg-[#FFFFFF]/80 rounded-xl p-4 mb-3 border border-[#C9A84C]/10">
        <p className="text-[10px] text-[#94A3B8] uppercase tracking-wider font-[family-name:var(--font-inter)]">
          Chiffre d&apos;affaires
        </p>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="bg-[#FFFFFF]/80 rounded-xl p-4 border border-[#C9A84C]/10">
          ...
          <p className="text-[10px] text-[#94A3B8] mt-0.5 font-[family-name:var(--font-inter)]">
            après dépenses
          </p>
        </div>
        <div className="bg-[#FFFFFF]/80 rounded-xl p-4 border border-[#C9A84C]/10">
