        ...
        <div className="bg-[#F2EDE4] rounded-2xl p-6 w-full max-w-md shadow-xl">
          <div className="flex flex-col items-center text-center mb-5">
            <div className="w-16 h-16 rounded-[16px] flex items-center justify-center mb-4" style={{ backgroundColor: "rgba(28,58,47,0.08)" }}>
              <FontAwesomeIcon icon={faWallet} className="w-7 h-7 text-[#1C3A2F]" />
            </div>
          ...
          <div className="mb-6">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full h-12 bg-white rounded-xl border border-[#E0D8CC] px-4 pl-16 text-sm text-[#1A1A1A] outline-none focus:border-[#1C3A2F] transition-colors"
                min="0"
              />
            </div>
            <p className="text-xs text-[#9BA89D] mt-2 font-[family-name:var(--font-inter)]">
          ...
          <div className="space-y-3">
            <button
              ...
              disabled={saving}
              className="w-full h-12 bg-[#1C3A2F] text-white rounded-xl font-[family-name:var(--font-inter)] font-semibold text-[15px] hover:bg-[#1C3A2F]/90 transition-colors cursor-pointer disabled:opacity-50"
            >
              {saving ? "..." : "Continuer"}
            </button>
            <button
