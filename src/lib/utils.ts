export { formatCurrency, formatDualCurrency, detectCurrency, detectBaseCurrency, formatEUR, formatXOF, toEUR, toXOF, resolveCurrency, setActiveCurrency, setActiveBaseCurrency, getCountryByCode, getCountryName, getCountryFlag, getCountryFlagDisplay, validatePhone, validatePhoneMessage, validateName, NAME_PATTERN, getCurrencyForCountry, convertForDisplay, convertForStorage, getPhonePrefix, ALLOWED_COUNTRIES, ALLOWED_COUNTRY_CODES, COUNTRY_OPTIONS, COUNTRY_CONFIG, roundByCurrency, toStorageCurrency, toDisplayCurrency, EUR_TO_FCFA } from "./currency";
