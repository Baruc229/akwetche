...
import { faChartPie, faUsers, faCrown, faShield, faChartLine } from '@fortawesome/free-solid-svg-icons';

const ADMIN_TABS = [
  { href: "/admin", label: "Vue d'ensemble", icon: faChartPie, exact: true },
  ...
  { href: "/admin/analytics", label: "Analytiques", icon: faChartLine, exact: false },
];
