    ...
    <div className="space-y-6">
      ...
      {loading ? (
        <div className="card divide-y divide-border animate-pulse">
          <div className="flex items-center justify-between p-4"><div className="space-y-2 flex-1"><div className="h-4 w-2/3 bg-stone/30 rounded-lg" /><div className="h-3 w-1/3 bg-stone/20 rounded-lg" /></div><div className="h-5 w-20 bg-stone/20 rounded-lg" /></div>
          <div className="flex items-center justify-between p-4"><div className="space-y-2 flex-1"><div className="h-4 w-1/2 bg-stone/30 rounded-lg" /><div className="h-3 w-1/4 bg-stone/20 rounded-lg" /></div><div className="h-5 w-16 bg-stone/20 rounded-lg" /></div>
          <div className="flex items-center justify-between p-4"><div className="space-y-2 flex-1"><div className="h-4 w-3/4 bg-stone/30 rounded-lg" /><div className="h-3 w-1/3 bg-stone/20 rounded-lg" /></div><div className="h-5 w-24 bg-stone/20 rounded-lg" /></div>
        </div>
