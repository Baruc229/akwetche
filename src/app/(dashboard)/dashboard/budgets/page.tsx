  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-2xl font-[family-name:var(--font-dm-sans)] font-bold text-[var(--color-ink)] mb-2">
          Budgets
        </h1>
        <p className="text-sm text-[var(--color-placeholder)] mb-6 leading-relaxed">
          Fixez des limites par catégorie et suivez vos dépenses en temps réel.
          Cette fonctionnalité arrive très bientôt.
        </p>
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-[var(--color-gold-light)] text-sm font-medium" style={{ color: 'var(--color-warn)' }}>
