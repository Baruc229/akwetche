    ...
    <div className="space-y-4">
      <div className="card overflow-hidden" style={{
          ...
          <div>
            <div className="flex items-center gap-2">
              <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl flex items-center justify-center" style={{background:'rgba(255,255,255,0.2)'}}>
                <FontAwesomeIcon icon={faArrowTrendUp} className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
              </div>
              <div>
                <h1 className="text-base sm:text-lg font-bold text-white">Revenus récurrents</h1>
                <p className="text-[10px] sm:text-xs text-white/70">Salaires, pensions, revenus locatifs</p>
              </div>
            </div>
            <p className="text-2xl sm:text-3xl font-bold text-white mt-3 sm:mt-4 tabular-nums">{formatCurrency(totalMonthly)}</p>
            <p className="text-[10px] sm:text-xs text-white/60 mt-0.5">Total mensuel des revenus actifs</p>
          </div>
        ...
        <div className="grid grid-cols-3 gap-px" style={{background:'rgba(255,255,255,0.1)'}}>
          <div className="p-2 sm:p-3" style={{background:'rgba(0,0,0,0.15)'}}>
            <p className="text-[9px] sm:text-[10px] text-white/60">Actifs</p>
            <p className="text-xs sm:text-sm font-bold text-white">{activeTemplates.length}/{templates.length}</p>
          </div>
          <div className="p-2 sm:p-3" style={{background:'rgba(0,0,0,0.15)'}}>
            <p className="text-[9px] sm:text-[10px] text-white/60">Reçus</p>
      ...
      {templates.length === 0 ? (
        <div className="card p-8 sm:p-12 text-center">
          <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl flex items-center justify-center mx-auto mb-4" style={{background:'var(--color-pos-bg)'}}>
            <FontAwesomeIcon icon={faArrowTrendUp} className="w-6 h-6 sm:w-7 sm:h-7" style={{color:'var(--color-pos)'}} />
          </div>
