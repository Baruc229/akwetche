    ...
    return (
      <div className="space-y-6 animate-pulse">
        <div className="flex items-center justify-between">
          ...
          <div className="h-10 w-40 bg-stone/30 rounded-xl" />
        </div>
        <div className="h-10 w-full bg-stone/20 rounded-xl" />
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="card p-4 space-y-3"><div className="h-4 w-3/4 bg-stone/30 rounded-lg" /><div className="h-4 w-1/2 bg-stone/20 rounded-lg" /><div className="h-8 w-24 bg-stone/20 rounded-lg" /></div>
          <div className="card p-4 space-y-3"><div className="h-4 w-3/4 bg-stone/30 rounded-lg" /><div className="h-4 w-1/2 bg-stone/20 rounded-lg" /><div className="h-8 w-24 bg-stone/20 rounded-lg" /></div>
        </div>
      </div>
    );
