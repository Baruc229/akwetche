  ...
  const html = `
    ...
    <body style="font-family:sans-serif;background:#f5f5f0;padding:40px 20px">
      <div style="max-width:480px;margin:0 auto;background:#fff;border-radius:12px;padding:32px;text-align:center">
        <div style="width:64px;height:64px;background:#E8EDF5;border-radius:50%;display:flex;align-items:center;justify-content:center;margin:0 auto 16px">
          <svg width="32" height="32" fill="none" stroke="#1B3A6B" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/></svg>
        </div>
        <h1 style="color:#1B3A6B;font-size:24px;margin:0 0 8px">Email vérifié !</h1>
        <p style="color:#666;line-height:1.6">Votre adresse email a été confirmée avec succès. Redirection automatique...</p>
        <a href="${redirectUrl}" style="display:inline-block;background:#1B3A6B;color:#fff;padding:12px 24px;border-radius:8px;text-decoration:none;font-weight:600;margin-top:16px">Continuer</a>
      </div>
    </body>
    </html>
  `;
